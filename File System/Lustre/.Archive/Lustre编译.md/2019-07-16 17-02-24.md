...
## 2.4 小结
在编译Lustre过程中遇到的最多问题是缺少相关的依赖，或者依赖的版本不对，根据错误提示去操作即可。如果遇到乱七八糟的问题，找一个干净的环境，最好是刚装完系统的环境，按照这个教程一步一步操作，就可以完成Lustre的s我本人在刚开始接触Lustre时，编译出现各种幺蛾子，导致编译出现各种问题，为此还专门请教过社区的大佬，现在回想起来，自己还是有很大的成长空间。
